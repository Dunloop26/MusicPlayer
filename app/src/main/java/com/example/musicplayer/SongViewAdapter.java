...
public class SongViewAdapter extends RecyclerView.Adapter<SongViewAdapter.SongViewHolder>{
	...
	private MP3Metadata[] mMetadataSongs;

	// Provide a suitable constructor (depends on the kind of dataset)
	public SongViewAdapter(MP3Metadata[] metadataSongs, OnSongListener onSongListener) {
	...
	public void onBindViewHolder(final SongViewHolder holder, int position) {
		mCurrentMetadata = mMetadataSongs[position];
